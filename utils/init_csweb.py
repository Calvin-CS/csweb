...
# This script loads raw data into the csweb production database.
# Load it into /data/init_csweb.py and run it manually from there.
# May need to chmod u+x to make it executable after coping it up, then
# say sudo ./init_csweb.py.

# This will reinitialize the collections in the database, which should
# only be done when initializing the website. After that, changes to the
# database should be made using the csweb's CMS tools or manually in the
# database (see update_csweb.py).
...
''',
     ...
     {'name': 'scholarships',
      'ordinal': 2,
      'title': 'Scholarships',
      'summary': 'Information on scholarships for current and incoming students',
      },         
     {'name': 'facilities', 
      'ordinal': 4,
      'title': 'Facilities',
...
<li><a href="https://calvin-csm.symplicity.com/students/" class="external">CalvinLink</a>: Calvin&rsquo;s Career Services maintains CalvinLink, a list of job opportunities.</li> 
    ...
    [{'name': 'cs',
      ...
      'shortDescription': '''<p>Calvin&rsquo;s <a href="http://www.abet.org/" alt="ABET organization">ABET</a>-accredited Bachelor of Computer Science degree and related degrees in information systems and digital media are taught from a <a href="/documents/christian_computing" alt="christian computing resources">Christian perspective</a> and will give you the opportunity to be <em>creative</em>, to <em>make a difference</em> and to pursue a <a href="/documents/computing_careers"><em>great career</em></a>.</p>
        <p>
            <iframe src="http://player.vimeo.com/video/23780397?title=0&amp;byline=0&amp;portrait=0" width="300" height="175"
                frameborder="0"></iframe> &nbsp;
           <iframe src="http://player.vimeo.com/video/24137603?title=0&amp;byline=0&amp;portrait=0" width="300" height="175"
                frameborder="0"></iframe>
            <br>
            <a href="http://vimeo.com/calvincomputerscience/">see more computing videos...</strong></a>
        </p>''',
          'longDescription': '''<p>
        ...
        <h2>Our Programs</h2>
        <p>
            Our <a href="/academics/bcs"><span class="caps">BCS</span></a> program is accredited by the CAC Accreditation Commission of ABET, 
            <a href="http://www.abet.org">http://www.abet.org</a>,
            a distinction we share with select programs around
            the country (e.g., <span class="caps">MIT</span>&rsquo;s BS in CS and Engineering program and Michigan&rsquo;s BSE program in Computer Science), and we&#8217;ve leveraged the <span class="caps">BCS</span>
            courses to build specialized programs in information systems, digital communication and digital art (see our <a
                href="/academics">academics page</a> or our <a href="/administration/assessment/plan">program goals</a>).
        </p>
        <p>
            ...
            a life-long vocation of service (see our <a href="/documents/christian_computing">essays on Christian scholarship</a>).
        </p>
        <h2>Our Students</h2>
...
<h2>Getting Started in Computing at Calvin</h2>
        ...
        <ul>
            ...
            <li>See our <a href="/resources/faqs" title="FAQ">frequently asked questions</a> for incoming students.
            </li>
    ...
    ''', 
    'honors': '''
     <p>Calvin challenges its best students by offering an honors program.  This program nurtures collaboration between individual students and faculty on projects of mutual interest.  All of the degrees offered by the department can be taken for honors.</p>
...
<ul>
<li><a href="/administration/honors/contract.html">Honors by Contract Form (<span class="caps">HTML</span>)</a></li>
</ul>''',
'courseSchedule': '''
...
<tr>
  ...
  <td><a href="/courses/cs/W60">CS W60 &#8211; Christian Computing: Thailand</a></td>
</tr>
</table>
'''
          }],
...
''',
#         'appInfo': None
         'applicationprocess': '<b>To Apply:</b> Create an account on the <a href="http://153.106.116.135/" class="external"> First-Year Scholarships home page.</a>, login and go to computer science scholarships for first-year students.'
        },
...
# 
         ...
         'content': '''<p>The Department of Computer Science has launched a new department website.
         The new site is based on tools developed by CIT that make the site responsive different device profiles.
         Let us know what you think by going to the <a href="/contact">contact page</a> and sending your comments and/or questions.</p>''',
         'date': datetime.strptime('2014-9-1', '%Y-%m-%d')
        },
           {'name': 'news_3',
            ...
            see <a href="/courses/cs/W60/">CS W60 - Christian Computing in Thailand</a>.</p>
''',
         'date': datetime.strptime('2014-8-25', '%Y-%m-%d')
           ...
           {'name': 'news_2',
            ...
            'content': '''<p>There are lots of summer internship opportunities here in W. Michigan.
...
start building your resume now by taking CS courses and pursuing one or more innovative personal projects that will make you an attractive prospect for these companies.</p>
''',
...
Computing Careers Market</a> page.</p>
''',
         'date': datetime.strptime('2014-8-14', '%Y-%m-%d')
            },
           {'name': 'news_0',
            ...
            'content': '''
<p>Prof. Adams has written two new introductory programming books, 
using the latest version of
<a href="http://alice.org" class="external">Alice</a>:</p>
<ul>
 <li>
...
<p>Both books introduce students to object-oriented programming concepts, including object-oriented design, objects and methods, control structures, data structures, and events.</p>
<p>
...
using a drag-and-drop integrated development environment that eliminates syntax errors.</p>
<p>
The new version uses 3D models donated by 
<a href="http://www.ea.com/" class="external">Electronic Arts</a>,
from its "The Sims" line of games.</p>''',
         'date': datetime.strptime('2014-8-25', '%Y-%m-%d')            
            }
        ],
# 
...
# Drop the current versions of the collections.
for collection in collections:
    collection.drop()
# Load the new versions of the collections as defined above.
