 ...
 * This version of the code turns off auto-compression of HTML files.
 * This ensures that in-line scripts don't get messed up and that the
 * raw HTML remains (relatively) readable after editing.
 * It was minifed by manually replacing the definition of extractToSting() with 
 * a single return string in the original minified version of the code.
 * -kvlinden, 15august2014 
 *
*/
...
(function($){		
	$.fn.jqte = function(options){
		...
		return this.each(function(){
			...
			{
			    // Don't do any of this string replacement (see the original code in jquery-te-1.4.0.js); 
			    // it messes up inline scripts and makes the HTML hard to read/edit. - kvlinden, 15aug2014 
			    return strings;
